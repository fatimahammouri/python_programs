# Boolean that will keep the program running until user inputs E
show_calculater = True

# TO DO:
# optimize choose formula function to reduce redundancy
...
def choose_formula(from_unit, to_unit, temp):
    ...
    # case: if the user inputs from kelvin to fahrenheit
        ...
        fahrenheit_temp =  temp * 9 / 5 - 459.67
        print(f"{temp:.2f}{from_unit.upper()} = {fahrenheit_temp:.2f}{to_unit.upper()}")
...
# Calculator program and prompts
...
# as long as user didn't input E keep running calculator program
